...
def crypt_image(path, message):
    ...
    with Image.open(path) as img:
        ...
        new_imagename = f'./to_decode/{new_imagename}-crp.png'
...
if __name__ == '__main__':
    ...
    if option == '1' or option == '2':
        ...
        if(os.path.exists(new_path)):
            ...
            print(f"[red]Oh... looks like the image {path} not exists, please be sure the image is in the '{folder}' folder[/red]")
    else:
